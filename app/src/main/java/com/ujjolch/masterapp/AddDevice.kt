    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.AddDevicePrompt1),
                    fontSize = 20.sp,
                ...
                Row {
                    ...
                    Text(
                        text = stringResource(id = R.string.AddDevicePrompt2),
                        fontSize = 16.sp,
                        textAlign = TextAlign.Center
                    )
                }
                Row {
                    ...
                    Text(
                        text = stringResource(id = R.string.AddDevicePrompt3),
                        fontSize = 16.sp,
                        textAlign = TextAlign.Center
                    )
                }
                ...
                if(!finddevice) {
                    Button(
                        ...
                        Text(text = stringResource(id = R.string.AddDevicePrompt4), color = Color.White)
                    }
                }
                if (showPrompt && !finddevice) {
                    Spacer(modifier = Modifier.height(24.dp))
                    Text(
                        text = stringResource(id = R.string.AddDevicePrompt5),
                        fontSize = 16.sp,
                    ...
                    Text(text = stringResource(id = R.string.AddDevicePrompt6),
                            fontSize = 16.sp,
                        fontWeight = FontWeight.ExtraBold,
                        textAlign = TextAlign.Center)
                    Text(text = stringResource(id = R.string.AddDevicePrompt7),
                        fontSize = 16.sp,
                        fontWeight = FontWeight.ExtraBold,
                        textAlign = TextAlign.Center)
                    ...
                    Button(onClick = { finddevice=false
                        ...
                        Text(text = stringResource(id = R.string.AddDevicePrompt8))
                    }
                    ...
                    Text(text = stringResource(id = R.string.AddDevicePrompt9),
                            fontSize = 16.sp,
                        fontWeight = FontWeight.ExtraBold,
                        textAlign = TextAlign.Center)
                }
